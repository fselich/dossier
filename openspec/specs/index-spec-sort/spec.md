# index-spec-sort Specification

## Purpose
Defines the sort-toggle behaviour for the Specifications section in `ModeIndex`, allowing the user to switch between full-name alphabetical order and suffix-based alphabetical order via the `s` key.
